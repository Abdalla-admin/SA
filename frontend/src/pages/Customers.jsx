  ...
  return (
    <div className="space-y-4">
      <div className="flex justify-between items-center">
        ...
        <button onClick={() => { setForm(empty); setModal(true); }} className="bg-orange-500 hover:bg-orange-600 text-white px-4 py-2 rounded-lg text-sm font-medium">+ New Customer</button>
      </div>
      ...
      {modal && (
        <Modal title={form.id?'Edit Customer':'New Customer'} onClose={()=>setModal(false)}>
